...
# BlurPool is used for downsampling in layers 2,3,4
import torch
...
def ResNet101(filter_size=3, num_classes=10, learnable=False):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, filter_size=filter_size, learnable=learnable)


def ResNet152(filter_size=3, num_classes=10, learnable=False):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, filter_size=filter_size, learnable=learnable)
