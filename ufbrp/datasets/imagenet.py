...
test_transforms = transforms.Compose(
    [
        transforms.Resize((226, 226), interpolation=transforms.InterpolationMode.BICUBIC),
...
class ImageNetDataset(BaseDataLoader):
    ...
    def get_val_dataset(self, val_transforms: Optional[transforms.Compose] = None) -> Dataset:
        # return ImageFolder(self.val_set_path, transform=val_transforms)
...
def get_data_loader(directory: str, num_workers: int, batch_size: int, val_split_ratio: float = 0.8):
    ...
    # print(imagenet.parse_meta_mat("/home/28i_mel@lab.graphicon.ru/unified-frequency-based-robustness-pipeline/data/imagenet"))
    # print(imagenet.get_train_dataset(train_transforms).class_to_idx)
    return (
